...
const highlights = [
  {
    value: "10×",
    label: "Faster Explanations",
    description: "Generate SHAP-quality results in milliseconds, not minutes.",
  },
  {
    value: "99%",
    label: "Feature Coverage",
    description:
      "Explains every input variable across all model architectures.",
  },
  {
    value: "—62%",
    label: "Audit Prep Time",
    description: "Automated evidence packages ready in one click.",
  },
  {
    value: "100%",
    label: "Regulatory Traceability",
    description: "Full decision logs stored and exportable on demand.",
  },
];
...
const problems = [
  {
    ...
    description:
      "Regulators and auditors reject AI outputs when models cannot articulate the reasoning behind every prediction.",
  },
  {
    icon: <ShieldOff className="w-6 h-6" />,
    title: "Compliance Gaps",
    description:
      "SR11-7 and EU AI Act demand documented rationale. Ad-hoc explainability tools leave dangerous gaps in evidence trails.",
  },
  {
    icon: <BarChart3 className="w-6 h-6" />,
    title: "Explanation Latency",
    description:
      "Post-hoc XAI libraries are too slow for real-time decisioning in credit, fraud, and trading workflows.",
  },
];
...
const steps = [
  {
    ...
    description:
      "Integrate any ML framework — scikit-learn, XGBoost, PyTorch — via REST API or our lightweight SDK in under 30 minutes.",
  },
  {
    step: "02",
    title: "Configure Explanation Rules",
    description:
      "Select SHAP, LIME, or our proprietary FastExplain™ algorithm. Set thresholds for feature importance and decision boundaries.",
  },
  {
    step: "03",
    title: "Generate Audit-Ready Reports",
    description:
      "Every prediction is wrapped with a human-readable explanation, a confidence score, and an immutable log entry—automatically.",
  },
  {
    step: "04",
    title: "Monitor & Govern in Production",
    description:
      "Dashboards surface explanation drift, flag anomalous decisions, and auto-escalate to human review when confidence drops below your configured threshold.",
  },
];
...
const ConnectedBankingPlatform = () => {
  return (
    <div className="relative w-full overflow-hidden bg-background text-white">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <HowItWorks
          ...
          heading={
            <>
              From black-box to <span className="text-blue-400">glass-box</span>{" "}
              in four steps.
            </>
          }
          steps={steps}
...
export default ConnectedBankingPlatform;
